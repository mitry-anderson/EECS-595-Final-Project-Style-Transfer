...
class GenreClassifier(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, middle_dim, num_class):
        self.lin1 = torch.nn.Linear(size=(hidden_dim, middle_dim))
        self.relu = torch.nn.ReLU()
        self.lin2 = torch.nn.Linear(size=(middle_dim, num_class))
        self.init_weights()
...
def main(params):
    ...
    if params.train:
        ...
        classifier = GenreClassifier(model.config.cross_attention_hidden_size, 32, 2)
